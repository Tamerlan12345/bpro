...
| 12 | Upgrade Gemini model | done | `backend/services/aiParserService.js` | Upgraded model from gemini-2.0-flash to gemini-3-flash-preview for better JSON structure extraction and reasoning. |
